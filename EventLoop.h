...
public:
   ...
   //config vars passed to EventLoop
   ...
   double m_DeltaPhi_LH;
   double m_DeltaPhi_LW;
...
EventLoop::~EventLoop()
{
   ...
   delete h_DeltaPhi_LH;
   delete h_DeltaPhi_LW;
...
void EventLoop::Init(TTree *tree, TString sampleName, TString ExpUncertaintyName)
{
   ...
   h_DeltaPhi_LH = new TH1Fs(sampleName + "_DeltaPhi_LH", "", 32, 0, 3.2, mySel, m_UncNames, ExpUncertaintyName);
   h_DeltaPhi_LW = new TH1Fs(sampleName + "_DeltaPhi_LW", "", 32, 0, 3.2, mySel, m_UncNames, ExpUncertaintyName);
